...
def fine_tuning(configs):
    ...
    path = configs["CNN"]["saving_path"] + "_".join(( "FT", CNN_name, configs["CNN"]["image_feature"], str(int(np.round(test_acc*100)))+"%", str(os.getpid()) + ".h5" ))
    model.save(path)
