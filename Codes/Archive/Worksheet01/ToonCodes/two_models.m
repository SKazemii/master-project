...
folder = [mode,'_',model_type,'_1.0_0.2']
...
FAR_L_av = mean(FAR_L);
%%%%%%%%%%%%% min
folder = [mode,'_',model_type,'_0.95_0.2']
cd(['/Users/saeedkazemi/Documents/Python/Worksheet/results/',folder,'/NPY/'])
...
legend(ax1,'without dimensionality reduction', 'with dimensionality reduction')
pbaspect(ax1,[1 1 1])
xlabel(ax1,'FAR')
ylabel(ax1,'FRR')
...
legend(ax2,'without dimensionality reduction', 'with dimensionality reduction')
pbaspect(ax2,[1 1 1])
xlabel(ax2,'FAR')
ylabel(ax2,'FRR')
